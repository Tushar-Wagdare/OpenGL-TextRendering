...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	glm::mat4 projection = glm::ortho(0.0f, static_cast<float>(WindowManager::SCR_WIDTH), 0.0f, static_cast<float>(WindowManager::SCR_HEIGHT));
	shader.use();
	...
	while (pWindow->isRunning == FALSE)
	{
		...
		else
		{
			...
			RenderText(shader, "Text Rendering", WindowManager::SCR_WIDTH / 2 - 250, WindowManager::SCR_HEIGHT / 2 + 100, 2.0f, glm::vec3(0.5, 0.8f, 0.2f));
			RenderText(shader, "- Tushar Wagdare", WindowManager::SCR_WIDTH / 2 + 150, WindowManager::SCR_HEIGHT / 2 - 50, 1.0f, glm::vec3(0.3, 0.7f, 0.9f));
